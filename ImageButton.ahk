...
;==============================================================
; ImageButton — GDI+ based image/gradient pushbutton renderer
;
; Original Project:  https://github.com/AHK-just-me/Class_ImageButton
; Fork:              https://github.com/SevenKeyboard/image-button
;
; Original Author:   just me (2013–2020)
; Fork Author:       SevenKeyboard Ltd. (2025)
...
;   2) Call ImageButton.Create(HWND, Options*).
;==============================================================
class VersionManager_ImageButton
{
...
Class ImageButton {
   ...
   ; PUBLIC METHODS ====================================================================================================
   ; ===================================================================================================================
   Create(HWND, FontFamily:=0, Options*) {
      ; Windows constants
      ...
      Else {
         ...
         EmSize := -LogFont.Height * 72 // A_ScreenDPI
         Style := FontStyleRegular | (LogFont.Weight >= 700 ? FontStyleBold : 0) | (LogFont.Italic ? FontStyleItalic : 0) | (LogFont.Underline ? FontStyleUnderline : 0) | (LogFont.StrikeOut ? FontStyleStrikeout : 0)
         Unit := UnitPoint
         DllCall("Gdiplus.dll\GdipCreateFont", "Ptr", FontFamily, "Float", EmSize, "Int", Style, "Int", Unit, "Ptr*", PFONT := 0, "Int")
      }
      If !(This.Font := PFONT)
      ...
      BtnCaption := RegExReplace(BtnCaption, "&(?!&)")
      BtnCaption := RegExReplace(BtnCaption, "&{2}", "&")
      ; ----------------------------------------------------------------------------------------------------------------
      ; Create a GDI+ bitmap
